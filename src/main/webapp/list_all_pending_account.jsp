...
<head>
<meta charset="UTF-8">
<title>Pending Account Request</title>
</head>
<body>
	Welcome,
	...
	<table width="100%" border="1">
		...
		<tr>
			...
			<td><a href="pending_account_accept.jsp?account_id=<%=rs.getInt("account_id")%>">Accept</a> &nbsp; <a href="pending_account_reject.jsp?account_id=<%=rs.getInt("account_id")%>">Reject</a></td>
		</tr>
		<%
		}
		conn.close();
